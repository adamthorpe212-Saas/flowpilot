  ...
  return (
    <div className={className}>
      ...
      <input
        ...
        className="mt-2 w-full rounded-xl border border-white/15 bg-white/[0.04] px-4 py-3 text-[15px] text-white placeholder:text-zinc-600 transition focus:border-white/40 focus:bg-white/[0.06] focus:outline-none focus:ring-2 focus:ring-white/10 disabled:opacity-50"
        {...props}
      />
      {hint && (
