export default function AIOrb() {
  return (
    <>
      ...
      <div className="absolute h-48 w-48 animate-pulse rounded-full border border-white/15 motion-reduce:animate-none sm:h-60 sm:w-60" />
      <div className="absolute h-24 w-24 rounded-full bg-white shadow-[0_0_100px_rgba(255,255,255,0.5)] sm:h-32 sm:w-32" />
